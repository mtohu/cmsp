...
namespace vendor\tp_wechat;
if (!defined('WECHAT_ROOT')) {
    define('WECHAT_ROOT', dirname(__FILE__) . '/');
}
require_once WECHAT_ROOT."WeLoader.php";
use vendor\tp_wechat\base\ErrCode;
use vendor\tp_wechat\src\Card;
use vendor\tp_wechat\src\Custom;
use vendor\tp_wechat\src\Device;
use vendor\tp_wechat\src\Extend;
use vendor\tp_wechat\src\Hardware;
use vendor\tp_wechat\src\Media;
use vendor\tp_wechat\src\Menu;
use vendor\tp_wechat\src\Message;
use vendor\tp_wechat\src\Oauth;
use vendor\tp_wechat\src\Poi;
use vendor\tp_wechat\src\Receive;
use vendor\tp_wechat\src\Script;
use vendor\tp_wechat\src\User;
use vendor\tp_wechat\support\Exception;
